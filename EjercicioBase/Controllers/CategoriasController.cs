...
namespace EjercicioBase.Controllers
{
    public class CategoriasController : Controller
    {
        private readonly EjercicioBaseContext _context;

        public CategoriasController(EjercicioBaseContext context)
        {
            _context = context;
        }
                                                ...
                                                int? page)
        {
            ...
            /*
             * from <Nombre-la-variable-que almacenará-un-elemento-a-la-vez-de-la-coleecion>
             * in <fuente-de-datos>
